  ...
  <div id="main">
    ...
    <div id="contents_search">
      ...
      <table id="tbl_search">
        ...
        <td><div class="inline_blk"><?=$this->Form->input("create_date_from",["type"=>"text","label"=>false,"class"=>"float_left datepicker","default"=>$sysdate,"class"=>"txt_width_130","maxlength"=>10,"autofocus"=>"autofocus"]) ?></div></td>
        <td><div class="inline_blk margin_left_10">受注日(To)：</div></td>
        <td><div class="inline_blk"><?=$this->Form->input("create_date_to",["type"=>"text","label"=>false,"class"=>"float_left datepicker","class"=>"txt_width_130","maxlength"=>10]) ?></div></td>
        </tr>
        <tr>
