  ...
  <div id="main">
    ...
    <div id="contents_search">
      ...
      <?=$this->Form->create(null,[
        ...
        <div class="input_search"> <?=$this->Form->input("jyucyu_no",["type"=>"text","maxlength"=>10,"label"=>"受注番号："]) ?></div>
        <h3>EXCELへ書込み</h3>
        <div class="input_search"> <?=$this->Form->input("biko",["type"=>"text","maxlength"=>50,"label"=>"引き取り予定日："]) ?> </div>
